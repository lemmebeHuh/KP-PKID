<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center mb-4">
                        {{-- Tombol Tambah --}}
                        <a href="{{ route('admin.service-orders.create') }}" class="w-full sm:w-auto bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg inline-flex items-center">
    ...
    <form action="{{ route('admin.service-orders.index') }}" method="GET" class="flex">
        <input type="text" name="search" class="w-full sm:w-64 border-gray-300 rounded-l-lg shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm" placeholder="Cari no. servis, nama, perangkat..." value="{{ request('search') }}">
