<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center mb-4">
                        {{-- Tombol Tambah --}}
                        <a href="{{ route('admin.users.create') }}" class="w-full sm:w-auto bg-primary hover:bg-primary-dark text-white font-bold py-2 px-4 rounded-lg inline-flex items-center">
    ...
    <form action="{{ route('admin.users.index') }}" method="GET" class="flex">
        <input type="text" name="search" class="w-full sm:w-64 border-gray-300 rounded-l-lg shadow-sm focus:border-primary focus:ring-primary text-sm" placeholder="Cari nama atau email..." value="{{ request('search') }}">
