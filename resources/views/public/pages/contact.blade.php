    ...
    <div class="py-24 sm:py-32">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:text-center">
                <h2 class="text-base font-semibold leading-7 text-primary">Hubungi Kami</h2>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-16">
            ...
            <div>
                ...
                <div class="mt-4 space-y-4 text-gray-600">
                    <div class="flex gap-x-3">
                        <svg class="h-6 w-6 flex-none text-primary" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 21h19.5m-18-18h18a2.25 2.25 0 012.25 2.25v10.5A2.25 2.25 0 0119.5 18.75H2.25A2.25 2.25 0 010 16.5V4.5A2.25 2.25 0 012.25 3z" /></svg>
                        <span>l. Sersan Sodik No.57 RT03, RW.2, Gg. Kelinci VI, Kec. Sukasari, Kota Bandung, Jawa Barat 40154</span>
                    </div>
                    <div class="flex gap-x-3">
                        <svg class="h-6 w-6 flex-none text-primary" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" /></svg>
                        <span><a href="https://wa.me/6283192310040" class="hover:text-primary">+62 812-7364-7463</a> (WhatsApp/Telepon)</span>
                    </div>
                    <div class="flex gap-x-3">
                        <svg class="h-6 w-6 flex-none text-primary" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" /></svg>
                        <span><a href="mailto:contact@pk.id" class="hover:text-primary">contact@pk.id</a></span>
                    </div>
                </div>
            ...
            <div class="bg-gray-50 p-6 rounded-lg shadow-inner">
                ...
                <form action="{{ route('contact.send') }}" method="POST">
                    ...
                    <div>
                        <button type="submit" class="w-full bg-primary hover:bg-primary-dark text-white font-bold py-3 px-4 rounded-md">
                            Kirim Pesan
                        </button>
                    </div>
                </form>
