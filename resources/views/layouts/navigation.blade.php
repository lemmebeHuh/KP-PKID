            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img class="block h-auto w-20 fill-current text-gray-800 dark:text-gray-200" src="{{ asset('pkid-logo.png') }}" alt="">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.categories.index')"
                        :active="request()->routeIs('admin.categories.*')"> {{-- Perhatikan .index atau .* --}}
                    ...
                    <x-nav-link :href="route('admin.service-orders.index')"
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    {{-- Tambahkan link navigasi teknisi lainnya di sini --}}
                </div>
                @endif
