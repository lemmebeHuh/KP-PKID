...
@auth
    <div x-data="{ open: false }" class="sm:hidden fixed bottom-5 right-5 z-50"> {{-- sm:hidden berarti hanya tampil di mobile --}}
        ...
        <button @click="open = !open" class="relative flex items-center justify-center h-14 w-14 bg-primary rounded-full text-white shadow-lg focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-dark">
